...
from heteqsys.evaluation.policy import EvaluationPolicy, RuntimeInjectionMode
...
EXECUTION_PLAN_SCHEMA_VERSION = "arqsim.execution-plan.v6"
    ...
    def __post_init__(self) -> None:
        ...
        for operation in operations:
            ...
            for implementation_recipe in implementation_recipes:
                ...
                if (
                    implementation_recipe.stages[0].attempt_duration_s
                    != operation.duration_s
                ):
                    raise ValueError(
                        f"Injection recipe {implementation_recipe.invocation_id} "
                        "stage-0 attempt duration must equal its host "
