...
from heteqsys.qec.protocol import get_entanglement_distillation_profile
    ...
    return FidelityProfile(
        ...
        provenance={
            ...
            "surface_memory": {
                ...
                "source_file": (
                    "Research/LightStim/paper_artifact/memory/precomputed/"
                    "fig1_surface_codes.csv"
                ),
                "physical_error_probability": 1e-3,
            ...
            "surface_logical_operations": {
                ...
                "source_files": {
                    "h": (
                        "Research/LightStim/paper_artifact/logical_ops/precomputed/"
                        "fig4_h.csv"
                    ),
                    "s": (
                        "Research/LightStim/paper_artifact/logical_ops/precomputed/"
            ...
            "surface_ppm": {
                ...
                "source_notebook": (
                    "Research/LightStim/notebooks/LogicalOps/multi_patch_LS.ipynb"
                ),
                "source_data": (
                    "Research/LightStim/benchmarks/logical_ops/results/"
                    "multi_patch_ppm_results.csv"
                ),
                "source_fit": (
                    "Research/LightStim/benchmarks/logical_ops/results/"
                    "multi_patch_ppm_fit_p1e-3.json"
                ),
                "configuration": (
                    "heteqsys/operation_profiles/fidelity_profiles/"
