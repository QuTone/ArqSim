...
from arqsim.program.circuit import (
...
from arqsim.program import FTCircuit, workload_stats
from .artifact import ARTIFACT_SCHEMA_VERSION, SynthesisArtifact


DEFAULT_CACHE_DIR = Path.home() / ".cache" / "arqsim" / "synthesis"
    ...
    def synthesize(
        ...
        *,
        ...
        try:
            ...
            workload = backend.load_workload(
                circuit_path,
                spec,
                provenance={
