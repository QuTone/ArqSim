...
from arqsim.schema import semantic_hash, strict_json


FOOTPRINT_MODEL_SCHEMA_VERSION = "arqsim.physical-footprint-model.v1"
FOOTPRINT_ESTIMATE_SCHEMA_VERSION = "arqsim.physical-footprint-estimate.v2"
RESOURCE_BUDGET_SCHEMA_VERSION = "arqsim.resource-budget.v1"
        ...
        *,
        ...
        return cls(
            ...
            provenance={
                ...
                "source": "arqsim.evaluation.footprint.estimate_physical_footprint",
