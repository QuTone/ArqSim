...
from arqsim.schema import canonical_json, deep_freeze_json, strict_json
from arqsim.schema import normalize_json as normalize_json_value

from .errors import LogicalCompilerValidationError


COMPILER_SPEC_SCHEMA_VERSION = "arqsim.logical-compiler-spec.v1"
...
class LogicalCompilerSpec:
    mapping: BackendSpec
    routing: BackendSpec
    instruction_set: str = "arqsim.hqisa.v1"
    ...
    def __post_init__(self) -> None:
        ...
        if self.instruction_set != "arqsim.hqisa.v1":
            raise LogicalCompilerValidationError(
    ...
    def from_dict(cls, data: Mapping[str, Any]) -> "LogicalCompilerSpec":
        ...
        result = cls(
            instruction_set=data.get("instruction_set", "arqsim.hqisa.v1"),
