...
def get_gallery_entry(profile_id: str) -> GalleryEntry:
    ...
    The public namespace prefix is accepted at this gallery lookup boundary.
    The Profile itself continues to own its unprefixed ID.
    """

    if not isinstance(profile_id, str):
        raise TypeError("Architecture Profile lookup ID must be a string")
    normalized = profile_id.removeprefix("arqsim.")
    try:
