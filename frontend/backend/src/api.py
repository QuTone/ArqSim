...
from heteqsys.architecture import list_architecture_profiles
from heteqsys.program import load_ft_workload, workload_stats
...
WorkloadRepresentation = Literal["clifford_t", "pbc"]
...
class EvaluationRequest(BaseModel):
    ...
    * ``workload`` carries an existing ``heteqsys.ft-workload.v2`` document.
